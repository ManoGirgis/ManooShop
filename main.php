    ...
    <div class="wrapper">
        <nav class="navbar navbar-expand navbar-dark navbar-light" id="mains">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="?controller=main&action=listcat" class="nav-link">Category</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <?php if (isset($_SESSION['User'])) { ?>
                    <li class="nav-item d-none d-sm-inline-block">
                        <a href="?controller=main&action=showcarrito" class="nav-link">
                            ...
                            <i class=""><span class="badge badge-warning navbar-primary"><?= compraController::numberss() ?></span></i>
                        </a>
                    </li>
                    ...
                    <li class="nav-item d-none d-sm-inline-block">
                        <a href="?controller=main&action=showusr" class="nav-link">
